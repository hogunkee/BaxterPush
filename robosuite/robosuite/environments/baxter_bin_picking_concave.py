...
from robosuite.models.tasks import BinPickingConcaveTask, UniformRandomSampler
# from robosuite.models.task import BinPickingTask

import matplotlib.pyplot as plt
from robosuite.gqcnn.policy_mujoco import evaluate_gqcnn

class BaxterBinPickingConcave(BaxterEnv):
    def __init__(
        self,
    ...
    def _load_model(self):
        ...
        self.ob_inits = [ConcaveObject]
        #self.ob_inits = [SquareNutObject]
        #self.ob_inits = [RoundNutObject]
        #self.ob_inits = [CerealObject]
        self.vis_inits = [
            MilkVisualObject,
            BreadVisualObject,
            CerealVisualObject,
        ...
        self.model = BinPickingConcaveTask(
            self.mujoco_arena,
            self.mujoco_robot,
            self.mujoco_objects,
            self.visual_objects,
