...
class BaxterBinPicking(BaxterEnv):
    def __init__(
        self,
    ...
    def _load_model(self):
        ...
        # self.vis_inits = [CanVisualObject]*15
        self.vis_inits = [
            MilkVisualObject,
            BreadVisualObject,
            CerealVisualObject,
        ...
        self.item_names = ["Can"+str(i) for i in range(3)] # , "Can2", "Can3", "Can4"]
    ...
    def _get_observation(self):
        ...
        if self.use_camera_obs:
            ...
            if self.run_gqcnn == True:
                # plt.imshow(di["image"])
                # plt.show()
                evaluate_gqcnn(di["image"], di["depth"], normalize=True)
...
class BaxterBinPickingSingle(BaxterBinPicking):
    """
...
class BaxterBinPickingMilk(BaxterBinPicking):
    """
...
class BaxterBinPickingBread(BaxterBinPicking):
    """
...
class BaxterBinPickingCereal(BaxterBinPicking):
    """
...
class BaxterBinPickingCan(BaxterBinPicking):
    """
