...
#sys.path.append('/home/scarab5/hogun_codes/mujoco/rl')
import gym

from nets.ppo import Agent
from rl.graph_drawer import Graph
...
def main(is_train=True, is_record=True):
    ...
    assert arg_parser.load_file('../rl/args_dobro.txt')
    '''
    ...
    env = CarlaEnv(obs_converter, action_converter, 0, reward_class_name='CarlaReward', port=3000)
