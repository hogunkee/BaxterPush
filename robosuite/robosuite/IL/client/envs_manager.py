...
def make_vec_envs(obs_converter, action_converter, starting_port, seed, num_processes, gamma,
                  device, reward_class_name, num_frame_stack=1, subset=None, norm_reward=True, norm_obs=True, video_every=10, video_dir='./video', apply_her=False,
    ...
    def __init__(self, venv, nstack, device=None):
        ...
        for k in wos.spaces:
            ...
            new_observation_spaces[k] = gym.spaces.Box(
                low=low, high=high, dtype=np.int32)#venv.observation_space.dtype)
