...
class CarlaEnv(object):
    ...
    def reset(self, pos='random', weather='random'):
        ...
        while True:
            try:
                ...
                if self.benchmark:
                    ...
                    self._new_episode(pos=pos, weather=weather)
    ...
    def _new_episode(self, pos='random', weather='random'): # pos='random'
        experiment_idx = np.random.randint(0, len(self._experiments)) if weather is 'random' else 0
        ...
        start_index = pose[0] if pos is 'random' else 116 #40
        end_index = pose[1] if pos is 'random' else 38 #27
    ...
    def _make_carla_client(self, host, port):
        ...
        while True:
            try:
                print('start making carla client..')
