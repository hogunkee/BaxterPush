...
class ProcessPlotter(object):
    ...
    def __call__(self, pipe):
        ...
        self.ax2.plot([], [], 'b')
        self.ax2.set_title('value loss')
        self.ax2.set_xlabel('iters')
        self.ax2.set_ylabel('')

        self.ax3 = self.fig.add_subplot(1,4,3)
        self.ax3.plot([], [], 'g')
        self.ax3.set_title('kl divergence')
...
class Graph:
    ...
    def update(self, reward, loss_v, kl, entropy, finished=False):
        self.count += 1
        ...
        if finished:
            ...
            send([self.count, reward, loss_v, kl, entropy])
